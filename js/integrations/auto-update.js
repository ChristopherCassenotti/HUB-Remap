...
(function(){
  ...
  function renderSupervisaoOnly() {
    ...
    const isDesempenhoPage = page === 'desempenho' || page === 'performance' || page === 'dashboard' || page === 'mywork' || page === 'equipe' || page === 'metas' || page === 'descontos';
    ...
    if (isDesempenhoPage) {
      try { if (typeof renderDesempenho === 'function' && page === 'desempenho') renderDesempenho(); } catch(e) {}
      try { if (typeof renderMyWork === 'function' && page === 'mywork') renderMyWork(); } catch(e) {}
  ...
  async function checkUpdates() {
    ...
    try {
      ...
      if (firstRun) {
        ...
        if (['mywork','dashboard','desempenho','supervisao'].includes(getActivePage())) renderSupervisaoOnly();
        return;
      }
