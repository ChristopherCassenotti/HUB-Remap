      ...
      <div class="timer-workspace-layout">
        <div class="timer-left-col">
          <div class="timer-card">
            ...
            <button type="button" class="btn-dark btn-sm" style="width:auto" onclick="addTaskLine()">+ Adicionar tarefa</button>
            ...
            <div id="taskTotalPreview" style="display:none;margin-top:12px;padding:12px 16px;background:rgba(168,85,247,.08);border:1px solid rgba(168,85,247,.25);border-radius:12px">
              <span style="color:#a855f7;font-weight:700;font-size:14px" id="taskTotalLabel"></span>
            </div>

            <label for="taskInput" style="margin-top:16px">Descrição geral <span style="color:var(--muted);font-weight:400;font-size:11px">(opcional)</span></label>
            <textarea id="taskInput" placeholder="Ex: Artes semana 3 do cliente Buiú, incluindo stories e carrossel..." style="min-height:60px"></textarea>
            ...
            <div class="timer-display-box">
              <div style="font-size:12px;color:var(--muted);font-weight:600;text-transform:uppercase;letter-spacing:.06em">Cronômetro</div>
        ...
        <aside class="timer-side-panel">
          <div class="timer-side-head">
            ...
            <div class="painel-view-switch" aria-label="Tipo de visualização do timer">
              ...
              <button class="painel-view-btn active" id="timerViewModeCalendarClickup" onclick="setTimerSideViewMode('calendar_clickup')">Calendar + ClickUp</button>
              <button class="painel-view-btn" id="timerViewModeClickup" onclick="setTimerSideViewMode('clickup')">ClickUp</button>
              <button class="painel-view-btn" id="timerViewModeNone" onclick="setTimerSideViewMode('none')">Nenhuma</button>
            </div>
          </div>
