...
<div id="page-retroativo" class="page" style="max-width:700px">
    ...
    <div class="timer-card">
        ...
        <button type="button" class="btn-dark btn-sm" style="width:auto" onclick="addRetroTaskLine()">+ Adicionar
            tarefa</button>

        <div id="retroTaskTotalPreview"
        ...
        <div class="grid-2" style="margin-top:14px">
            ...
            <div
                style="display:flex;align-items:flex-end;color:var(--muted);font-size:12px;line-height:1.4;padding-bottom:8px">
                No modo por tempo, a cada 30 minutos completos soma metade do valor base novamente.
            </div>
        </div>

        <label for="rTaskInput" style="margin-top:14px">Descrição geral <span
        ...
        <div
            style="margin-top:18px;padding:18px;background:var(--bg);border:1px solid var(--border);border-radius:14px">
            <div
                style="font-size:12px;color:var(--muted);font-weight:700;text-transform:uppercase;letter-spacing:.06em;margin-bottom:14px">
                <i class="bi bi-calendar-event"></i> Data e horário</div>
            ...
            <div style="margin-top:4px">
                <div
                    style="font-size:12px;color:var(--muted-2);font-weight:600;letter-spacing:.04em;text-transform:uppercase;margin:14px 0 10px">
                    Como prefere informar o tempo?</div>
            ...
            <div id="retroModeHorario">
                ...
                <div id="rDurationPreview" style="margin-top:10px;font-size:13px;color:var(--muted);min-height:20px">
                </div>
            </div>
