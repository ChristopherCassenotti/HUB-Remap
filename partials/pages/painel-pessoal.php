...
<div id="page-painel" class="page active">
    <div
        ...
        <div class="painel-view-switch" aria-label="Tipo de visualização do painel">
            ...
            <button class="painel-view-btn active" id="viewModeCalendarClickup"
                onclick="setPainelViewMode('calendar_clickup')">Calendar + ClickUp</button>
    ...
    <div class="painel-grid mode-calendar-clickup" id="painelGrid">
        ...
        <div class="painel-card painel-col-shortcuts">
            <div class="painel-card-header">
                <h3><i class="bi bi-link-45deg"></i>Atalhos</h3>
            ...
            <div class="shortcut-search">
                ...
                <input id="googleSearch" placeholder="🔍 Google..."
                    onkeydown="if(event.key==='Enter')window.open('https://google.com/search?q='+encodeURIComponent(this.value),'_blank')"
                    style="flex:1;font-size:13px;padding:8px 12px;border-radius:10px" />
            </div>
        ...
        <div class="painel-card painel-col-tasks">
            ...
            <div class="painel-tasks-grid">
                <div class="painel-task-col">
                    <div class="painel-task-col-head painel-card-header">
                        <h3><i class="bi bi-pin-angle"></i> Tarefas pessoais</h4>
                    ...
                    <div class="task-add-box">
                        <input id="personalTaskInput" placeholder='Ex: "Reunião hoje" ou "Ligar amanhã"'
                        ...
                        <div style="display:flex;align-items:center;gap:6px;margin-top:8px;flex-wrap:wrap">
                            ...
                            <input id="ptDate" type="date"
                                style="width:auto;padding:4px 8px;font-size:12px;border-radius:8px"
                                title="Ou escreva no título: hoje, amanhã..." />
                            <button class="btn-primary btn-sm" style="margin-left:auto" onclick="addPersonalTask()">+
                                Adicionar</button>
                        </div>
                    </div>
                ...
                <div class="painel-task-col painel-clickup-col" id="clickupTasksPanel" style="display:none">
                    <div class="painel-task-col-head">
                        <h4><i class="bi bi-folder"></i> ClickUp</h4>
                ...
                <div class="painel-task-col painel-notes-inline-col" id="notesTasksPanel" style="display:none">
                    <div class="painel-task-col-head">
                        <h4><i class="bi bi-journal-bookmark"></i> Notas do dia</h4>
                        <span>salvo automático</span>
                    </div>
                    <textarea class="notes-area" id="painelNotesInline" placeholder="Suas anotações do dia..."
                        oninput="saveNotes(this)" style="flex:1;min-height:330px"></textarea>
                    <button class="btn-dark btn-sm" style="margin-top:10px;align-self:flex-end"
                        onclick="clearNotes()">Limpar notas</button>
                </div>
            </div>
        </div>
        ...
        <div class="painel-card painel-col-notes" style="display:flex;flex-direction:column">
            <div class="painel-card-header">
                <h3><i class="bi bi-journal-bookmark"></i> Notas do dia</h3>
                <button class="btn-dark btn-sm" onclick="clearNotes()">Limpar</button>
            </div>
            <textarea class="notes-area" id="painelNotes" placeholder="Suas anotações do dia..."
                oninput="saveNotes(this)" style="flex:1;min-height:220px"></textarea>
            <p
                style="font-size:11px;color:var(--muted);margin-top:8px;border-top:1px solid var(--border);padding-top:8px">
                Notas salvas automaticamente na sessão.</p>
        </div>
