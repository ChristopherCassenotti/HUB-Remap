...
<div id="desempenhoPage" class="hidden" style="position:fixed;inset:0;background:var(--bg);z-index:200;overflow-y:auto;">
  <div style="max-width:1100px;margin:0 auto;padding:28px 32px">

    <!-- Header -->
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:28px;padding-bottom:20px;border-bottom:1px solid var(--border)">
      <div style="display:flex;align-items:center;gap:14px">
        <div class="logo" style="font-size:20px">🏆</div>
        <div>
          <h1 style="font-size:22px;font-weight:800">Desempenho</h1>
          <p id="desempenhoSubtitle" style="font-size:13px;color:var(--muted);margin-top:2px">Suas metas, pontos e evolução.</p>
        </div>
      </div>
      <div style="display:flex;align-items:center;gap:10px">
        <div id="desempenhoUserPill" style="background:var(--surface-2);border:1px solid var(--border);border-radius:99px;padding:8px 14px;font-size:13px;color:var(--muted-2)"></div>
    ...
    <div id="desTab-meu">
      ...
      <div style="display:flex;align-items:center;gap:10px;margin-bottom:18px">
        ...
        <select id="desPeriodSel" onchange="renderDesempenho()" style="width:auto;padding:8px 14px;font-size:13px">
      ...
      <div class="card" style="margin-bottom:18px">
        <h3>📈 Evolução mensal de pontos</h3>
        <canvas id="pontosMonthChart" style="max-height:240px;margin-top:12px"></canvas>
      </div>

      <div class="card">
        <h3>📋 Tarefas e pontos — mês atual</h3>
        <div class="table-wrap" style="margin-top:12px">
          <table>
            <thead><tr><th>Data</th><th>Cliente</th><th>Tarefa</th><th>Pontos</th></tr></thead>
    ...
    <div id="desTab-equipe" style="display:none">
      <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:18px;flex-wrap:wrap;gap:10px">
        <select id="desEquipeMes" onchange="renderEquipeDesempenho()" style="width:auto;padding:8px 14px;font-size:13px">
          <option value="current">Mês atual</option>
          <option value="last">Mês anterior</option>
          <option value="all">Todo o período</option>
        </select>
        <span style="font-size:12px;color:var(--muted)">Atualizado em tempo real com os registros do sistema</span>
      </div>
      ...
      <div class="card" style="margin-bottom:18px">
        ...
        <div class="table-wrap" style="margin-top:12px">
          <table>
            <thead><tr><th>Colaborador</th><th>Cargo</th><th>Tarefas</th><th>Pts brutos</th><th>Descontos</th><th>Pts líquidos</th><th>Meta 7%</th><th>Meta 14%</th><th>Meta 21%</th><th>Nível</th></tr></thead>
    ...
    <div id="desTab-tabela" style="display:none">
      <div style="margin-bottom:16px">
        <select id="desTabelaRole" onchange="renderTabelaPontos()" style="width:auto;padding:8px 14px;font-size:13px">
      ...
      <div class="card">
        <p style="font-size:12px;color:var(--muted);margin-bottom:14px">Pontos são atribuídos automaticamente com base na descrição da tarefa registrada.</p>
        <div class="table-wrap">
          <table>
            <thead><tr><th>Tarefa</th><th style="width:140px">Pontuação</th></tr></thead>
